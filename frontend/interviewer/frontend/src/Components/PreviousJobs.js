...
const PreviousJobs = () => {
  ...
  return (
<<<<<<<< HEAD:InterviewerFrontend/src/Components/PreviousJobs.js
    <div className=" dark:bg-gray-900 rounded-lg py-2">
========
    <div className=" dark:bg-gray-900 rounded-lg">
>>>>>>>> 4b974221d4dcc15b66d6d09a3f2088e8ebfae046:frontend/interviewer/frontend/src/Components/PreviousJobs.js
